...
import {Box, Button, Dialog,DialogContent,  DialogTitle,IconButton,Table,TableBody,TableCell,  TableContainer,TableHead,TableRow, Typography,Paper,  Divider,useTheme,useMediaQuery} from "@mui/material";
...
const isMobile=useMediaQuery(theme.breakpoints.down("sm"));
 ...
 const tableContainerStyle = {borderRadius: "5px",mb: 4,border: borderStyle };
const cellBorderRight = {
  ...
  return (
    <Box>
      <Button variant="contained" color="primary" onClick={handleOpen}> Try </Button>
...
<Box sx={{  
        ...
        <DialogContent sx={{  
          ...
          <TableContainer component={Paper}  elevation={0} sx={{ borderRadius: "5px",
              overflowX: isMobile ? "auto" : "hidden",
              mb: 4,
              border: borderStyle}}>
            <Table size="small" sx={{ borderCollapse: "separate", minWidth:400}}>
            ...
            <Table size="small" sx={{ minWidth:500 }}>
              ...
              <TableBody sx={{ backgroundColor:"#d6e6f7ff" }}>
                {duplicatesData.map((row, index) => (
                  ...
                  >
                    <TableCell
                      sx={{ fontWeight: "600", ...cellBorderRight }}
                    >
                      {row.company}
                    </TableCell>
