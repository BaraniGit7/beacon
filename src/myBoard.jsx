    ...
    <Box sx={{ p: 2, width: "100%" }}>
      ...
      {!showCredentials ? (
        <>
          ...
          {/* Edit Dialog */}
          <Dialog open={openEdit} onClose={closeDialogs}>
            <DialogTitle sx={{
            display: "flex",
      ...
      fontSize: "1.25rem",
          ...
          {/* Add Dialog */}
          <Dialog open={openAdd} onClose={closeDialogs}>
            <DialogTitle>Add Seafarer</DialogTitle><Divider/>
            <DialogContent sx={{ display: "flex", flexDirection: "column", gap: 2, mt:1 }}>
              <TextField label="Name" id="add-name"/>
              <TextField label="Email" id="add-email"/>
               <TextField label="Id" id="add-Id"/>
                <TextField label="passport" id="add-passport"/>
                 <TextField label="location" id="add-location"/>
              <TextField label="Phone" id="add-phone"/>
              <TextField label="Role" id="add-role"/>
              <TextField label="Ship Name" id="add-ship"/>
                <TextField label="Ship Name1" id="add-ship1"/>
            </DialogContent>
            <DialogActions>
              ...
              <Button variant="contained" onClick={() => {
                const newSeafarer = {
                  ...
                  loaction: document.getElementById("add-location").value,
          ...
          {/* Password Dialog */}
          <Dialog open={openPassword} onClose={closeDialogs}>
