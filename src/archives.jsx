    ...
    <Box sx={{ p: 2, width: "100%" }}>
      ...
      {!showCredentials ? (
        <>
          ...
          {/* Edit Dialog */}
          <Dialog open={openEdit} onClose={closeDialogs} fullWidth maxWidth="lg">        
             <DialogTitle sx={{
...
<Box  sx={{
  ...
  <DialogContent sx={{  px: 2, py: 2 }}>
    <Grid container spacing={2}>
      ...
      <Grid size={6} item xs={12} sm={6} md={6}> <Typography >Name</Typography>
      ...
      <Grid size={6} item xs={12} sm={6} md={6}> <Typography >Lo</Typography>
      ...
      <Grid item xs={12} sm={6} md={6}> <Typography >Name</Typography>
