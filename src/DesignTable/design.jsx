...
const MyDialog = () => {
  ...
  const tableContainerStyle = {
    borderRadius: "5px",
    overflowX: "auto", // allow horizontal scroll always
    border: borderStyle,
    my: 2,
    mx: 2, // spacing on both sides
  };
    ...
    <Box>
      ...
      >
        ...
        <DialogContent sx={{ p: 0, maxHeight: "70vh", overflowY: "auto" }}>
          ...
          {/* Duplicates Table */}
          <TableContainer component={Paper} elevation={0} sx={tableContainerStyle}>
            <Table sx={{ minWidth: 600, borderCollapse: "collapse" }} size="small">
